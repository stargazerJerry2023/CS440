...
public class Dataset
    ...
    public static class BatchIterator
        ...
        protected final Matrix getFullX() {
            return this.X;
        }

        protected final Matrix getFullYGt() {
            return this.YGt;
        }

        protected final long getBatchSize() {
            return this.batchSize;
        }

        protected final long getNumBatches() {
            return this.numBatches;
        }

        protected long getCurrentBatchIdx() {
            return this.currentBatchIdx;
        }

        private void setCurrentBatchIdx(long l) {
            this.currentBatchIdx = l;
        }

        @Override
        public boolean hasNext() {
            return this.getCurrentBatchIdx() < this.getNumBatches();
        }
    ...
    public BatchIterator iterator() {
        return new BatchIterator(this.getFullX(),
                this.getFullYGt(),
                this.getBatchSize(),
                this.size());
    }
